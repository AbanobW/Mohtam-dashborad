...
import { ArticlesTable } from "../../../_metronic/partials/widgets/tables/ArticlesTable";
import { AddArticlesForm } from "../Components/AddArticlesForm";
...
const AddArticlesWrapper = () => {
	const intl = useIntl();
	return (
		<>
			<PageTitle breadcrumbs={[]}>Articles</PageTitle>
			<ArticlesPage />
		</>
	);
};

export { AddArticlesWrapper };
